  ...
  return (
    ...
    <div style={{ padding: '20px', textAlign: 'center' }}>
      ...
      <div className="sort-bar" style={{ marginBottom: '16px', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '10px' }}>
        <label htmlFor="sort-select" style={{ color: '#aaa' }}>Trier par :</label>
        <select
          id="sort-select"
          value={sortBy}
      ...
      <div className="filters-bar" style={{ marginBottom: '16px', display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', gap: '10px' }}>
        <label htmlFor="filter-genre" style={{ color: '#aaa' }}>Genre :</label>
        <select
          id="filter-genre"
          value={filterGenre}
        ...
        <label htmlFor="filter-year" style={{ color: '#aaa' }}>Année :</label>
        <input
          id="filter-year"
          type="text"
          inputMode="numeric"
        ...
        />
        <label htmlFor="filter-rating" style={{ color: '#aaa' }}>Note min :</label>
        <input
          id="filter-rating"
          type="text"
          inputMode="decimal"
